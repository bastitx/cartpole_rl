...
class ActorModel(nn.Module):
    def __init__(self, state_space, action_space, parameter_space, init_w=0.003):
        ...
        self.fc1 = nn.Linear(self.state_space.shape[0]+self.parameter_space.shape[0], 400)
    ...
    def init_weights(self, init_w):
        self.fc1.weight.data.uniform_(-1./np.sqrt(self.state_space.shape[0]+self.parameter_space.shape[0]), 1./np.sqrt(self.state_space.shape[0]+self.parameter_space.shape[0]))
...
class OsiModel(nn.Module):
    def __init__(self, state_space, action_space, parameter_space, init_w=0.003):
        ...
        self.fc1 = nn.Linear(self.state_space.shape[0], 256)
